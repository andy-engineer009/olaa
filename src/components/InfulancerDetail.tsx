      ...
      <div className="min-h-screen bg-gray-50">
                  ...
                  <div className="space-y-4">
                    ...
                    {audienceType && (
                      <div className="bg-orange-50 rounded-xl p-4">
                        <p className="text-sm text-gray-500 mb-1">Audience Type</p>
        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 py-4 px-6 z-30">
          <div className="flex items-center justify-between">
            ...
            <button 
              onClick={handleChat}
              className="flex-1 ml-6 py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition-colors"
            >
              Chat Now
            </button>
          </div>
