      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            {/* Profile Image */}
            <div className="w-full lg:w-1/4 bg-gradient-to-r from-orange-500 to-orange-600 p-8">
            ...
            {/* Profile Info */}
            <div className="flex-1 min-w-0 w-full w:md-auto">
              <div className="flex flex-col items-center md:items-start">
                {/* Name, Verification & Username */}
                <div className="flex items-center space-x-2 mb-2">
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{name}</h1>
                  {isVerified && (
                    <div className="bg-blue-500 text-white p-1 rounded-full" title="Verified Profile">
                  ...
                  <div className="flex space-x-3">
                    ...
                    {youtubeUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-red-600 text-white p-3 rounded-full hover:scale-110 transition-transform duration-200"
